            ...
            <Fade key = {item.path + index} >
              <div className = {`h-full col-span-${12/itemsToShow} flex justify-center items-center ${item.className}`}>
                <div className = 'flex flex-col items-center w-full h-full'>
                  <div className = {'relative w-full h-60 md:h-72 duration-200 ease-out cursor-pointer hover:opacity-80 i '+imageStyles+' '+item.color} onClick = {() => onClickImage && onClickImage()}>
                    <Image
